    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-xl">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h4 className="text-xl font-semibold">Assistente de Tecnologia</h4>
                <p className="text-gray-700 dark:text-gray-400">IA Sonia</p>
              </div>
              <span className="text-gray-700 dark:text-gray-400 text-sm">Ago/2023 - Ago/2024</span>
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-black dark:text-gray-300">Otimização do processo de instalação de softwares</span>
              </li>
              <li className="flex items-start">
                <span className="text-cyan-400 mr-2">✓</span>
                <span className="text-black dark:text-gray-300">Organização do inventário de TI e controle de ativos</span>
              </li>
              <li className="flex items-start">
                <span className="text-cyan-400 mr-2">✓</span>
                <span className="text-black dark:text-gray-300">Resolução de problemas técnicos complexos</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-xl mb-6">
            <div className="flex justify-between items-start mb-2">
              <div>
                <h4 className="text-xl font-semibold">Engenharia de Computação</h4>
                <p className="text-gray-700 dark:text-gray-400">Fainor-BA</p>
              </div>
              <span className="text-gray-700 dark:text-gray-400 text-sm">Concluído em 2025</span>
            </div>
          </div>
